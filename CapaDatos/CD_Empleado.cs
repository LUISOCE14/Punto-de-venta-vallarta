        ...
        public List<Empleado> Listar()
        {
            ...
            using (SqlConnection cconexion = new SqlConnection(Conexion.cadena))
            {
                ...
                try
                {
                    ...
                    query.AppendLine("select e.idEmpleado,e.Nombre,e.Direccion,e.Telefono,e.Correo,e.Estado,r.IdRol,r.Descripcion from Empleados e");
                    query.AppendLine("inner join Rol r on r.IdRol = e.Cargo");
                    ...
                    using (SqlDataReader dr = cmd.ExecuteReader())
                    {
                        ...
                        while (dr.Read())
                        {
                            lista.Add(new Empleado()
                            {
                                ...
                                Cargo = new Rol() { IdRol = Convert.ToInt32(dr["IdRol"]), descripcion = dr["Descripcion"].ToString() }
        ...
        public int RegistrarEmpleado(Empleado obj, out string mensaje)
        {
            ...
            try
            {
                using (SqlConnection cconexion = new SqlConnection(Conexion.cadena))
                {
                    ...
                    cmd.Parameters.AddWithValue("cargo", obj.Cargo.IdRol);
